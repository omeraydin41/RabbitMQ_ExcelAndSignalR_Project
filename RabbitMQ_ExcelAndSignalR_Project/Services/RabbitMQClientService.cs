using Microsoft.Extensions.Logging;              // Loglama altyapısını kullanmak için
using RabbitMQ.Client;                           // RabbitMQ istemci kütüphanesi

namespace RabbitMQ_ExcelAndSignalR_Project.Services
{
    // RabbitMQ ile bağlantı kurup kanal yöneten servis sınıfı
